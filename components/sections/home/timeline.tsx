...
const TimelinePage = () => {
    ...
    const data = [
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-medium md:text-lg ">
            Built and launched Medora Web from scratch
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4 text-xs font-medium  md:text-lg ">
            we will be working on company integration..
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
              src="https://assets.aceternity.com/pro/hero-sections.png"
